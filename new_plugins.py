...
class DownloadSVG(plugins.PluginBase):
	...
	var svg_save_icon = "data:image/png;base64,";

	mpld3.register_plugin("downloadsvg", DownloadSVG);
	DownloadSVG.prototype = Object.create(mpld3.Plugin.prototype);

	DownloadSVG.prototype.constructor = DownloadSVG;
	DownloadSVG.prototype.requiredProps = ["returnstr"];
	DownloadSVG.prototype.defaultProps = {};
	...
	function DownloadSVG(fig, props){
		mpld3.Plugin.call(this, fig, props);
		var n = (this.props.returnstr).toString();
		var ResetButton = mpld3.ButtonFactory({
		buttonID: "reset",
		...
		icon: function(){return svg_save_icon;
		}
		});
		this.fig.buttons.push(ResetButton);
	};
