...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[15] = RNALfold_args_info_detailed_help[16];
  RNALfold_args_info_full_help[16] = RNALfold_args_info_detailed_help[18];
  ...
  RNALfold_args_info_full_help[19] = RNALfold_args_info_detailed_help[22];
  RNALfold_args_info_full_help[20] = RNALfold_args_info_detailed_help[24];
  RNALfold_args_info_full_help[21] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_full_help[22] = 0; 
  
}

const char *RNALfold_args_info_full_help[23];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[16];
  RNALfold_args_info_help[16] = RNALfold_args_info_detailed_help[18];
  ...
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_help[20] = 0; 
  
}

const char *RNALfold_args_info_help[21];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->temp_help = RNALfold_args_info_detailed_help[12] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[13] ;
  args_info->dangles_help = RNALfold_args_info_detailed_help[14] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[16] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[18] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[19] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[20] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[22] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[24] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVL:z::T:4d:P:e:", long_options, &option_index);
