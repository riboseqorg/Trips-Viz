...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[27] = RNAeval_args_info_detailed_help[40];
  RNAeval_args_info_full_help[28] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_full_help[29] = RNAeval_args_info_detailed_help[43];
  RNAeval_args_info_full_help[30] = RNAeval_args_info_detailed_help[45];
  ...
  RNAeval_args_info_full_help[37] = 0; 
  
}

const char *RNAeval_args_info_full_help[38];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[23] = RNAeval_args_info_detailed_help[40];
  RNAeval_args_info_help[24] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_help[25] = RNAeval_args_info_detailed_help[43];
  ...
  RNAeval_args_info_help[33] = 0; 
  
}

const char *RNAeval_args_info_help[34];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->logML_help = RNAeval_args_info_detailed_help[38] ;
  args_info->shape_help = RNAeval_args_info_detailed_help[40] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[41] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[43] ;
  args_info->mis_help = RNAeval_args_info_detailed_help[45] ;
  args_info->cfactor_help = RNAeval_args_info_detailed_help[46] ;
  args_info->nfactor_help = RNAeval_args_info_detailed_help[47] ;
  args_info->ribosum_file_help = RNAeval_args_info_detailed_help[48] ;
  args_info->ribosum_scoring_help = RNAeval_args_info_detailed_help[49] ;
  args_info->old_help = RNAeval_args_info_detailed_help[50] ;
