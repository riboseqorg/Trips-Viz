...
init_full_help_array(void)
{
  ...
  RNAplot_args_info_full_help[6] = RNAplot_args_info_detailed_help[8];
  RNAplot_args_info_full_help[7] = RNAplot_args_info_detailed_help[10];
  RNAplot_args_info_full_help[8] = RNAplot_args_info_detailed_help[11];
  RNAplot_args_info_full_help[9] = RNAplot_args_info_detailed_help[12];
  RNAplot_args_info_full_help[10] = RNAplot_args_info_detailed_help[13];
  RNAplot_args_info_full_help[11] = RNAplot_args_info_detailed_help[15];
  ...
  RNAplot_args_info_full_help[14] = RNAplot_args_info_detailed_help[19];
  RNAplot_args_info_full_help[15] = RNAplot_args_info_detailed_help[20];
  RNAplot_args_info_full_help[16] = RNAplot_args_info_detailed_help[21];
  RNAplot_args_info_full_help[17] = RNAplot_args_info_detailed_help[22];
  RNAplot_args_info_full_help[18] = RNAplot_args_info_detailed_help[23];
  RNAplot_args_info_full_help[19] = RNAplot_args_info_detailed_help[24];
  RNAplot_args_info_full_help[20] = RNAplot_args_info_detailed_help[25];
  RNAplot_args_info_full_help[21] = RNAplot_args_info_detailed_help[27];
  RNAplot_args_info_full_help[22] = RNAplot_args_info_detailed_help[29];
  RNAplot_args_info_full_help[23] = RNAplot_args_info_detailed_help[31];
  RNAplot_args_info_full_help[24] = RNAplot_args_info_detailed_help[33];
  RNAplot_args_info_full_help[25] = RNAplot_args_info_detailed_help[35];
  RNAplot_args_info_full_help[26] = RNAplot_args_info_detailed_help[37];
  RNAplot_args_info_full_help[27] = RNAplot_args_info_detailed_help[39];
  RNAplot_args_info_full_help[28] = 0; 
  
}

const char *RNAplot_args_info_full_help[29];
...
init_help_array(void)
{
  ...
  RNAplot_args_info_help[6] = RNAplot_args_info_detailed_help[8];
  RNAplot_args_info_help[7] = RNAplot_args_info_detailed_help[10];
  RNAplot_args_info_help[8] = RNAplot_args_info_detailed_help[11];
  RNAplot_args_info_help[9] = RNAplot_args_info_detailed_help[12];
  RNAplot_args_info_help[10] = RNAplot_args_info_detailed_help[15];
  ...
  RNAplot_args_info_help[15] = RNAplot_args_info_detailed_help[21];
  RNAplot_args_info_help[16] = RNAplot_args_info_detailed_help[22];
  RNAplot_args_info_help[17] = RNAplot_args_info_detailed_help[23];
  RNAplot_args_info_help[18] = RNAplot_args_info_detailed_help[24];
  RNAplot_args_info_help[19] = RNAplot_args_info_detailed_help[25];
  RNAplot_args_info_help[20] = RNAplot_args_info_detailed_help[27];
  RNAplot_args_info_help[21] = RNAplot_args_info_detailed_help[39];
...
void init_args_info(struct RNAplot_args_info *args_info)
{
  ...
  args_info->jobs_help = RNAplot_args_info_detailed_help[4] ;
  ...
  args_info->covar_help = RNAplot_args_info_detailed_help[11] ;
  args_info->aln_help = RNAplot_args_info_detailed_help[12] ;
  args_info->aln_EPS_cols_help = RNAplot_args_info_detailed_help[13] ;
  args_info->layout_type_help = RNAplot_args_info_detailed_help[15] ;
  args_info->noOptimization_help = RNAplot_args_info_detailed_help[17] ;
  args_info->ignoreExteriorIntersections_help = RNAplot_args_info_detailed_help[18] ;
  args_info->ignoreAncestorIntersections_help = RNAplot_args_info_detailed_help[19] ;
  args_info->ignoreSiblingIntersections_help = RNAplot_args_info_detailed_help[20] ;
  args_info->allowFlipping_help = RNAplot_args_info_detailed_help[21] ;
  args_info->output_format_help = RNAplot_args_info_detailed_help[22] ;
  args_info->pre_help = RNAplot_args_info_detailed_help[23] ;
  args_info->post_help = RNAplot_args_info_detailed_help[24] ;
  args_info->auto_id_help = RNAplot_args_info_detailed_help[25] ;
  args_info->id_prefix_help = RNAplot_args_info_detailed_help[27] ;
  args_info->id_delim_help = RNAplot_args_info_detailed_help[29] ;
  args_info->id_digits_help = RNAplot_args_info_detailed_help[31] ;
  args_info->id_start_help = RNAplot_args_info_detailed_help[33] ;
  args_info->filename_delim_help = RNAplot_args_info_detailed_help[35] ;
  args_info->filename_full_help = RNAplot_args_info_detailed_help[37] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNAplot_args_info_purpose) > 0)
    printf("\n%s\n", RNAplot_args_info_purpose);

  if (strlen(RNAplot_args_info_usage) > 0)
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVj::i:at:o:", long_options, &option_index);
...
.  */
          ...
          break;
        case 'o':	/* Specify output format. Available formats are: PostScript (ps), Graph Meta Language (gml), Scalable Vector Graphics (svg), and XRNA save file (xrna). Output filenames will end in \".ps\" \".gml\" \".svg\" \".ss\", respectively.
