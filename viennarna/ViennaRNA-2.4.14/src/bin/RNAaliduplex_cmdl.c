...
init_help_array(void)
{
  ...
  RNAaliduplex_args_info_help[11] = RNAaliduplex_args_info_detailed_help[12];
  RNAaliduplex_args_info_help[12] = RNAaliduplex_args_info_detailed_help[14];
  ...
  RNAaliduplex_args_info_help[15] = RNAaliduplex_args_info_detailed_help[18];
  RNAaliduplex_args_info_help[16] = RNAaliduplex_args_info_detailed_help[20];
  RNAaliduplex_args_info_help[17] = 0; 
  
}

const char *RNAaliduplex_args_info_help[18];
...
void init_args_info(struct RNAaliduplex_args_info *args_info)
{
  ...
  args_info->version_help = RNAaliduplex_args_info_detailed_help[2] ;
  args_info->deltaEnergy_help = RNAaliduplex_args_info_detailed_help[5] ;
  args_info->sorted_help = RNAaliduplex_args_info_detailed_help[6] ;
  args_info->temp_help = RNAaliduplex_args_info_detailed_help[8] ;
  args_info->noTetra_help = RNAaliduplex_args_info_detailed_help[9] ;
  args_info->dangles_help = RNAaliduplex_args_info_detailed_help[10] ;
  args_info->noLP_help = RNAaliduplex_args_info_detailed_help[12] ;
  args_info->noGU_help = RNAaliduplex_args_info_detailed_help[14] ;
  args_info->noClosingGU_help = RNAaliduplex_args_info_detailed_help[15] ;
  args_info->nsp_help = RNAaliduplex_args_info_detailed_help[16] ;
  args_info->paramFile_help = RNAaliduplex_args_info_detailed_help[18] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNAaliduplex_args_info_purpose) > 0)
    printf("\n%s\n", RNAaliduplex_args_info_purpose);

  if (strlen(RNAaliduplex_args_info_usage) > 0)
