...
init_help_array(void)
{
  ...
  RNAdos_args_info_help[13] = RNAdos_args_info_detailed_help[15];
  RNAdos_args_info_help[14] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_help[15] = RNAdos_args_info_detailed_help[17];
  RNAdos_args_info_help[16] = 0; 
  
}

const char *RNAdos_args_info_help[17];
...
void init_args_info(struct RNAdos_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNAdos_args_info_detailed_help[13] ;
  args_info->hashtable_bits_help = RNAdos_args_info_detailed_help[16] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNAdos_args_info_purpose) > 0)
    printf("\n%s\n", RNAdos_args_info_purpose);

  if (strlen(RNAdos_args_info_usage) > 0)
