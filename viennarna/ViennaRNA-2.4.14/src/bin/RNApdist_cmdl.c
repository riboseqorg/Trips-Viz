...
const char *RNApdist_args_info_usage = "Usage: RNApdist [OPTIONS]...";
...
init_full_help_array(void)
{
  ...
  RNApdist_args_info_full_help[18] = RNApdist_args_info_detailed_help[23];
  RNApdist_args_info_full_help[19] = RNApdist_args_info_detailed_help[24];
  RNApdist_args_info_full_help[20] = 0; 
  
}

const char *RNApdist_args_info_full_help[21];
...
init_help_array(void)
{
  ...
  RNApdist_args_info_help[17] = RNApdist_args_info_detailed_help[24];
  RNApdist_args_info_help[18] = 0; 
  
}

const char *RNApdist_args_info_help[19];
...
void init_args_info(struct RNApdist_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNApdist_args_info_detailed_help[19] ;
  args_info->nsp_help = RNApdist_args_info_detailed_help[21] ;
  args_info->energyModel_help = RNApdist_args_info_detailed_help[23] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNApdist_args_info_purpose) > 0)
    printf("\n%s\n", RNApdist_args_info_purpose);

  if (strlen(RNApdist_args_info_usage) > 0)
