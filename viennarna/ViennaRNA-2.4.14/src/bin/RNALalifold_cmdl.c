...
init_full_help_array(void)
{
  ...
  RNALalifold_args_info_full_help[41] = RNALalifold_args_info_detailed_help[60];
  RNALalifold_args_info_full_help[42] = RNALalifold_args_info_detailed_help[62];
  ...
  RNALalifold_args_info_full_help[48] = 0; 
  
}

const char *RNALalifold_args_info_full_help[49];
...
init_help_array(void)
{
  ...
  RNALalifold_args_info_help[36] = RNALalifold_args_info_detailed_help[63];
  ...
  RNALalifold_args_info_help[41] = 0; 
  
}

const char *RNALalifold_args_info_help[42];
...
void init_args_info(struct RNALalifold_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[58] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[60] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[62] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[63] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[64] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[65] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[66] ;
