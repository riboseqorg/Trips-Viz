...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[23] = RNALfold_args_info_detailed_help[35];
  RNALfold_args_info_full_help[24] = RNALfold_args_info_detailed_help[36];
  RNALfold_args_info_full_help[25] = RNALfold_args_info_detailed_help[38];
  ...
  RNALfold_args_info_full_help[29] = RNALfold_args_info_detailed_help[43];
  RNALfold_args_info_full_help[30] = RNALfold_args_info_detailed_help[44];
  RNALfold_args_info_full_help[31] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_full_help[32] = RNALfold_args_info_detailed_help[48];
  RNALfold_args_info_full_help[33] = RNALfold_args_info_detailed_help[49];
  RNALfold_args_info_full_help[34] = RNALfold_args_info_detailed_help[50];
  RNALfold_args_info_full_help[35] = RNALfold_args_info_detailed_help[52];
  RNALfold_args_info_full_help[36] = RNALfold_args_info_detailed_help[54];
  RNALfold_args_info_full_help[37] = RNALfold_args_info_detailed_help[55];
  RNALfold_args_info_full_help[38] = 0; 
  
}

const char *RNALfold_args_info_full_help[39];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[35];
  RNALfold_args_info_help[16] = RNALfold_args_info_detailed_help[40];
  RNALfold_args_info_help[17] = RNALfold_args_info_detailed_help[41];
  RNALfold_args_info_help[18] = RNALfold_args_info_detailed_help[42];
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[44];
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_help[21] = RNALfold_args_info_detailed_help[50];
  RNALfold_args_info_help[22] = RNALfold_args_info_detailed_help[55];
  RNALfold_args_info_help[23] = 0; 
  
}

const char *RNALfold_args_info_help[24];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->gquad_help = RNALfold_args_info_detailed_help[34] ;
  args_info->shape_help = RNALfold_args_info_detailed_help[35] ;
  args_info->shapeMethod_help = RNALfold_args_info_detailed_help[36] ;
  args_info->shapeConversion_help = RNALfold_args_info_detailed_help[38] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[42] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[43] ;
  args_info->dangles_help = RNALfold_args_info_detailed_help[44] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[46] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[48] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[49] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[50] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[52] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[54] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvL:o::i:z::gT:4d:P:e:", long_options, &option_index);
