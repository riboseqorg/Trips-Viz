...
.  */
 ...
 help description.  */
  char * shape_arg;	/**< @brief Use SHAPE reactivity data in the folding recursions (does not work for Zuker suboptimals and stochastic backtracking yet)
  
.  */
  char * shape_orig;	/**< @brief Use SHAPE reactivity data in the folding recursions (does not work for Zuker suboptimals and stochastic backtracking yet)
  
 original value given at command line.  */
  const char *shape_help; /**< @brief Use SHAPE reactivity data in the folding recursions (does not work for Zuker suboptimals and stochastic backtracking yet)
...
.  */
 ...
 help description.  */
  int stochBT_en_arg;	/**< @brief Same as \"--stochBT\" but also print out the energies and probabilities of the backtraced structures.
  
.  */
  char * stochBT_en_orig;	/**< @brief Same as \"--stochBT\" but also print out the energies and probabilities of the backtraced structures.
  
 original value given at command line.  */
  const char *stochBT_en_help; /**< @brief Same as \"--stochBT\" but also print out the energies and probabilities of the backtraced structures.
...
.  */
 ...
 help description.  */
  int zuker_flag;	/**< @brief Compute Zuker suboptimals instead of all suboptimal structures within an engery band around the MFE.
  
 (default=off).  */
  const char *zuker_help; /**< @brief Compute Zuker suboptimals instead of all suboptimal structures within an engery band around the MFE.
