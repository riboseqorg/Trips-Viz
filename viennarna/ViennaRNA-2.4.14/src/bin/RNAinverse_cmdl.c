...
const char *RNAinverse_args_info_usage = "Usage: RNAinverse [OPTIONS]...";
...
init_full_help_array(void)
{
  ...
  RNAinverse_args_info_full_help[20] = RNAinverse_args_info_detailed_help[24];
  ...
  RNAinverse_args_info_full_help[23] = 0; 
  
}

const char *RNAinverse_args_info_full_help[24];
...
init_help_array(void)
{
  ...
  RNAinverse_args_info_help[20] = RNAinverse_args_info_detailed_help[27];
  RNAinverse_args_info_help[21] = 0; 
  
}

const char *RNAinverse_args_info_help[22];
...
void init_args_info(struct RNAinverse_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNAinverse_args_info_detailed_help[22] ;
  args_info->nsp_help = RNAinverse_args_info_detailed_help[24] ;
  args_info->energyModel_help = RNAinverse_args_info_detailed_help[26] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNAinverse_args_info_purpose) > 0)
    printf("\n%s\n", RNAinverse_args_info_purpose);

  if (strlen(RNAinverse_args_info_usage) > 0)
