...
const char *RNAsubopt_args_info_detailed_help[] = {
  ...
  "      --energyModel=INT         Rarely used option to fold sequences from the\n                                  artificial ABCD... alphabet, where A pairs B,\n                                  C-D etc.  Use the energy parameters for GC\n                                  (-e 1) or AU (-e 2) pairs.\n\n",
...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[31] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_full_help[32] = RNAsubopt_args_info_detailed_help[47];
  RNAsubopt_args_info_full_help[33] = RNAsubopt_args_info_detailed_help[49];
  RNAsubopt_args_info_full_help[34] = RNAsubopt_args_info_detailed_help[50];
  RNAsubopt_args_info_full_help[35] = RNAsubopt_args_info_detailed_help[51];
  RNAsubopt_args_info_full_help[36] = RNAsubopt_args_info_detailed_help[52];
  RNAsubopt_args_info_full_help[37] = RNAsubopt_args_info_detailed_help[54];
  RNAsubopt_args_info_full_help[38] = RNAsubopt_args_info_detailed_help[55];
  RNAsubopt_args_info_full_help[39] = RNAsubopt_args_info_detailed_help[57];
  RNAsubopt_args_info_full_help[40] = RNAsubopt_args_info_detailed_help[58];
  RNAsubopt_args_info_full_help[41] = RNAsubopt_args_info_detailed_help[59];
  RNAsubopt_args_info_full_help[42] = RNAsubopt_args_info_detailed_help[60];
  RNAsubopt_args_info_full_help[43] = RNAsubopt_args_info_detailed_help[61];
  RNAsubopt_args_info_full_help[44] = RNAsubopt_args_info_detailed_help[63];
  RNAsubopt_args_info_full_help[45] = RNAsubopt_args_info_detailed_help[65];
  RNAsubopt_args_info_full_help[46] = RNAsubopt_args_info_detailed_help[67];
  RNAsubopt_args_info_full_help[47] = RNAsubopt_args_info_detailed_help[68];
  RNAsubopt_args_info_full_help[48] = RNAsubopt_args_info_detailed_help[69];
  RNAsubopt_args_info_full_help[49] = RNAsubopt_args_info_detailed_help[71];
  RNAsubopt_args_info_full_help[50] = RNAsubopt_args_info_detailed_help[73];
  RNAsubopt_args_info_full_help[51] = RNAsubopt_args_info_detailed_help[75];
  RNAsubopt_args_info_full_help[52] = RNAsubopt_args_info_detailed_help[76];
  RNAsubopt_args_info_full_help[53] = RNAsubopt_args_info_detailed_help[78];
  RNAsubopt_args_info_full_help[54] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[55];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[16] = RNAsubopt_args_info_detailed_help[31];
  RNAsubopt_args_info_help[17] = RNAsubopt_args_info_detailed_help[33];
  RNAsubopt_args_info_help[18] = RNAsubopt_args_info_detailed_help[34];
  RNAsubopt_args_info_help[19] = RNAsubopt_args_info_detailed_help[35];
  RNAsubopt_args_info_help[20] = RNAsubopt_args_info_detailed_help[36];
  RNAsubopt_args_info_help[21] = RNAsubopt_args_info_detailed_help[38];
  RNAsubopt_args_info_help[22] = RNAsubopt_args_info_detailed_help[42];
  RNAsubopt_args_info_help[23] = RNAsubopt_args_info_detailed_help[43];
  RNAsubopt_args_info_help[24] = RNAsubopt_args_info_detailed_help[44];
  RNAsubopt_args_info_help[25] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_help[26] = RNAsubopt_args_info_detailed_help[47];
  RNAsubopt_args_info_help[27] = RNAsubopt_args_info_detailed_help[49];
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[50];
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[51];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[54];
  RNAsubopt_args_info_help[31] = RNAsubopt_args_info_detailed_help[55];
  RNAsubopt_args_info_help[32] = RNAsubopt_args_info_detailed_help[57];
  RNAsubopt_args_info_help[33] = RNAsubopt_args_info_detailed_help[58];
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[59];
  RNAsubopt_args_info_help[35] = RNAsubopt_args_info_detailed_help[60];
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[61];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[63];
  RNAsubopt_args_info_help[38] = RNAsubopt_args_info_detailed_help[65];
  RNAsubopt_args_info_help[39] = RNAsubopt_args_info_detailed_help[67];
  RNAsubopt_args_info_help[40] = RNAsubopt_args_info_detailed_help[68];
  RNAsubopt_args_info_help[41] = RNAsubopt_args_info_detailed_help[69];
  RNAsubopt_args_info_help[42] = RNAsubopt_args_info_detailed_help[71];
  RNAsubopt_args_info_help[43] = RNAsubopt_args_info_detailed_help[78];
  RNAsubopt_args_info_help[44] = 0; 
  
}

const char *RNAsubopt_args_info_help[45];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->deltaEnergyPost_help = RNAsubopt_args_info_detailed_help[45] ;
  args_info->sorted_help = RNAsubopt_args_info_detailed_help[47] ;
  args_info->stochBT_help = RNAsubopt_args_info_detailed_help[49] ;
  args_info->stochBT_en_help = RNAsubopt_args_info_detailed_help[50] ;
  args_info->nonRedundant_help = RNAsubopt_args_info_detailed_help[51] ;
  args_info->pfScale_help = RNAsubopt_args_info_detailed_help[52] ;
  args_info->circ_help = RNAsubopt_args_info_detailed_help[54] ;
  args_info->dos_help = RNAsubopt_args_info_detailed_help[55] ;
  args_info->zuker_help = RNAsubopt_args_info_detailed_help[57] ;
  args_info->gquad_help = RNAsubopt_args_info_detailed_help[58] ;
  args_info->temp_help = RNAsubopt_args_info_detailed_help[60] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[61] ;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[63] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[65] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[67] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[68] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[69] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[71] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[73] ;
  args_info->energyModel_help = RNAsubopt_args_info_detailed_help[75] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[76] ;
...
.  */
          ...
          break;
        case 'z':	/* Compute Zuker suboptimals instead of all suboptimal structures within an engery band around the MFE.
