...
const char *PKplex_args_info_usage = "Usage: RNAPKplex [OPTIONS]...";
...
init_help_array(void)
{
  ...
  PKplex_args_info_help[11] = PKplex_args_info_detailed_help[13];
  PKplex_args_info_help[12] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_help[13] = PKplex_args_info_detailed_help[16];
  PKplex_args_info_help[14] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_help[15] = PKplex_args_info_detailed_help[19];
  PKplex_args_info_help[16] = 0; 
  
}

const char *PKplex_args_info_help[17];
...
void init_args_info(struct PKplex_args_info *args_info)
{
  ...
  args_info->noconv_help = PKplex_args_info_detailed_help[10] ;
  args_info->nsp_help = PKplex_args_info_detailed_help[11] ;
  args_info->energyCutoff_help = PKplex_args_info_detailed_help[13] ;
  args_info->paramFile_help = PKplex_args_info_detailed_help[14] ;
  args_info->verbose_help = PKplex_args_info_detailed_help[16] ;
  args_info->subopts_help = PKplex_args_info_detailed_help[17] ;
...
static void print_help_common(void) {
  ...
  if (strlen(PKplex_args_info_purpose) > 0)
    printf("\n%s\n", PKplex_args_info_purpose);

  if (strlen(PKplex_args_info_usage) > 0)
