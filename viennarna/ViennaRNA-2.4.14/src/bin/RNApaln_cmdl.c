...
const char *RNApaln_args_info_usage = "Usage: RNApaln [OPTIONS]...";
...
init_full_help_array(void)
{
  ...
  RNApaln_args_info_full_help[23] = RNApaln_args_info_detailed_help[28];
  RNApaln_args_info_full_help[24] = RNApaln_args_info_detailed_help[30];
  RNApaln_args_info_full_help[25] = RNApaln_args_info_detailed_help[31];
  RNApaln_args_info_full_help[26] = 0; 
  
}

const char *RNApaln_args_info_full_help[27];
...
init_help_array(void)
{
  ...
  RNApaln_args_info_help[23] = RNApaln_args_info_detailed_help[31];
  RNApaln_args_info_help[24] = 0; 
  
}

const char *RNApaln_args_info_help[25];
...
void init_args_info(struct RNApaln_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNApaln_args_info_detailed_help[26] ;
  args_info->nsp_help = RNApaln_args_info_detailed_help[28] ;
  args_info->energyModel_help = RNApaln_args_info_detailed_help[30] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNApaln_args_info_purpose) > 0)
    printf("\n%s\n", RNApaln_args_info_purpose);

  if (strlen(RNApaln_args_info_usage) > 0)
