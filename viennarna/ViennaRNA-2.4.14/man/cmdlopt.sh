...
case $2 in
  --help)           no --show-help --set-version=2.4.14 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
  --version)        echo 2.4.14;;
  --detailed-help)  no --show-detailed-help --set-version=2.4.14 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
esac
