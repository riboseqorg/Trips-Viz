...
\begin{DoxyCompactItemize}
\item 
typedef struct \mbox{\hyperlink{group__kl__neighborhood__mfe_structvrna__sol__TwoD__t}{vrna\+\_\+sol\+\_\+\+Two\+D\+\_\+t}} \mbox{\hyperlink{group__kl__neighborhood__mfe_ga6a81a58268d250309712549a3fa0aab2}{vrna\+\_\+sol\+\_\+\+Two\+D\+\_\+t}}
...
typedef struct \mbox{\hyperlink{group__kl__neighborhood__mfe_structTwoDfold__vars}{Two\+Dfold\+\_\+vars}} \mbox{\hyperlink{group__kl__neighborhood__mfe_gaf4f514010a14f9d59d850742b3e96954}{Two\+Dfold\+\_\+vars}}
\begin{DoxyCompactList}\small\item\em Variables compound for 2Dfold M\+FE folding. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\subsubsection{\texorpdfstring{vrna\_sol\_TwoD\_t}{vrna\_sol\_TwoD\_t}}
...
\subsubsection{\texorpdfstring{TwoDfold\_vars}{TwoDfold\_vars}}
...
\subsubsection{\texorpdfstring{vrna\_mfe\_TwoD()}{vrna\_mfe\_TwoD()}}
...
The returned list contains an entry for each distance class. If a maximum basepair distance to either of the references was passed, an entry with k=l=-\/1 will be appended in the list, denoting the class where all structures exceeding the maximum will be thrown into. The end of the list is denoted by an attribute value of \mbox{\hyperlink{constants_8h_a12c2040f25d8e3a7b9e1c2024c618cb6}{I\+NF}} in the k-\/attribute of the list entry.
...
\subsubsection{\texorpdfstring{destroy\_TwoDfold\_variables()}{destroy\_TwoDfold\_variables()}}
...
\subsubsection{\texorpdfstring{TwoDfoldList()}{TwoDfoldList()}}
...
\index{Computing MFE representatives of a Distance Based Partitioning@{Computing MFE representatives of a Distance Based Partitioning}!TwoDfold@{TwoDfold}}
\index{TwoDfold@{TwoDfold}!Computing MFE representatives of a Distance Based Partitioning@{Computing MFE representatives of a Distance Based Partitioning}}
\subsubsection{\texorpdfstring{TwoDfold()}{TwoDfold()}}
