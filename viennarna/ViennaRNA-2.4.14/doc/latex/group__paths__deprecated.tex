\hypertarget{group__paths__deprecated}{}\section{Deprecated Interface for (Re-\/)folding Paths, Saddle Points, and Energy Barriers}
...
\subsubsection{\texorpdfstring{path\_t}{path\_t}}
