...
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc = \mbox{\hyperlink{group__fold__compound_ga6601d994ba32b11511b36f68b08403be}{vrna\_fold\_compound}}(seq, NULL, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* allocate memory for MFE structure (length + 1) */}}
\DoxyCodeLine{  \textcolor{keywordtype}{char}                  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gaf37a0979367c977edfb9da6614eebe99}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{group__soft__constraints_ga069915fe203a2c8e522dd37847177a09}{vrna\_sc\_add\_up}}(fc, 5, -1.7, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* allocate memory for MFE structure (length + 1) */}}
...
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *vc = \mbox{\hyperlink{group__fold__compound_ga6601d994ba32b11511b36f68b08403be}{vrna\_fold\_compound}}(seq, NULL, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
...
\Hypertarget{examples_python_examples_python_subopt}%
 \subsection*{Suboptimal Structure Prediction }
...
\Hypertarget{examples_python_examples_python_pbacktrack}%
 \subsection*{Boltzmann Sampling (a.\+k.\+a. Probabilistic Backtracing) }
...
\Hypertarget{examples_python_examples_python_MEA}%
 \subsection*{R\+N\+Afold -\/p --M\+EA equivalent }
...
\Hypertarget{examples_python_examples_python_soft_constraints}%
 \subsection*{Fun with Soft Constraints }
