...
\DoxyCodeLine{00064 \mbox{\hyperlink{group__eval__loops__int_gaab3547bfcdc39d89babbc7ed2a1a4b65}{vrna\_eval\_int\_loop}}(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}} *fc,}
...
\DoxyCodeLine{00129 \mbox{\hyperlink{group__mfe__backtracking_ga28015cfbd0afc759b94ff58cc241cb13}{vrna\_BT\_stack}}(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc,}
...
\DoxyCodeLine{00142 \mbox{\hyperlink{group__mfe__backtracking_ga90b5a5723173996fb40640ce7c95c07e}{vrna\_BT\_int\_loop}}(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}} *fc,}
...
\DoxyCodeLine{00490 }
\DoxyCodeLine{00491   energy = \mbox{\hyperlink{constants_8h_a12c2040f25d8e3a7b9e1c2024c618cb6}{INF}};}
\DoxyCodeLine{00492 }
...
\DoxyCodeLine{00668 \{}
\DoxyCodeLine{00669   \textcolor{keywordtype}{int} energy, ci, cj, cp, cq, d3, d5, d5\_2, d3\_2, tmm, tmm\_2;}
\DoxyCodeLine{00670 }
...
\DoxyCodeLine{00700       energy += tmm + tmm\_2;}
\DoxyCodeLine{00701     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (j - q == 2)}
\DoxyCodeLine{00702       energy += (cj \&\& cq) ? \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(tmm + d5\_2, tmm\_2 + d3) : tmm + tmm\_2;}
\DoxyCodeLine{00703     \textcolor{keywordflow}{else}}
\DoxyCodeLine{00704       energy += d3 + d5\_2;}
\DoxyCodeLine{00705   \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (p - i == 2) \{}
\DoxyCodeLine{00706     \textcolor{keywordflow}{if} (j - q > 2)}
\DoxyCodeLine{00707       energy += (ci \&\& cp) ? \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(tmm + d3\_2, tmm\_2 + d5) : tmm + tmm\_2;}
\DoxyCodeLine{00708     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (j - q == 2)}
\DoxyCodeLine{00709       energy += \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(tmm, \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(tmm\_2, \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(d5 + d5\_2, d3 + d3\_2)));}
\DoxyCodeLine{00710     \textcolor{keywordflow}{else}}
\DoxyCodeLine{00711       energy += \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(d3, d5\_2);}
\DoxyCodeLine{00712   \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{00713     \textcolor{keywordflow}{if} (j - q > 2)}
\DoxyCodeLine{00714       energy += d5 + d3\_2;}
\DoxyCodeLine{00715     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (j - q == 2)}
\DoxyCodeLine{00716       energy += \mbox{\hyperlink{group__utils_gae0b9cd0ce090bd69b951aa73e8fa4f7d}{MIN2}}(d5, d3\_2);}
\DoxyCodeLine{00717   \}}
\DoxyCodeLine{00718 }
\DoxyCodeLine{00719   \textcolor{keywordflow}{return} energy;}
\DoxyCodeLine{00720 \}}
\DoxyCodeLine{00721 }
\DoxyCodeLine{00722 }
