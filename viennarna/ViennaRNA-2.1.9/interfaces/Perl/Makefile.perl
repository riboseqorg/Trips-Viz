...
# 6.9 (Revision: 69000) from the contents of
...
#     BUILD_REQUIRES => {  }
#     CCFLAGS => q[-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS) -I../../H]
#     CONFIGURE_REQUIRES => {  }
#     LD => q[${CXX}]
#     LIBS => [q[-lm]]
...
CCFLAGS = -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS) -I../../H
OPTIMIZE = -O2 -g
PERLTYPE = 
MPOLLUTE = 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 6.9, CPAN::Meta::Converter version 2.120351'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.9, CPAN::Meta::Converter version 2.120351",' >> META_new.json
