...
def generate_plot(data, settings) -> str:
    ...
    for seq_type in file_paths_dict:
        if seq_type not in ["riboseq", "rnaseq"]:
            ...
            if not frame_breakdown:
                ...
                frame0_altseqplot = ax_main.plot(
                    alt_frame_counts[0].keys(),
                ...
                frame1_altseqplot = ax_main.plot(
                    alt_frame_counts[1].keys(),
                ...
                frame2_altseqplot = ax_main.plot(
                    alt_frame_counts[2].keys(),
    ...
    if seqhili != [""]:
        ...
        frame1_subsequences = ax_f1.plot(
            near_cog_starts[0],
        ...
        frame2_subsequences = ax_f2.plot(
            near_cog_starts[1],
        ...
        frame3_subsequences = ax_f3.plot(
            near_cog_starts[2],
    ...
    if user_hili_starts != [] and user_hili_stops != []:
        for i in range(0, len(user_hili_starts)):
            ...
            try:
                hili += ax_main.fill_between(
                    [user_hili_start, user_hili_stop],
                    [y_max, y_max],
                    alpha=0.75,
                    color="#fffbaf",
                )
