!function(d3) {
  ...
  mpld3_Toolbar.prototype.draw = function() {
    ...
    function showButtons() {
      this.buttonsobj.transition(1750).attr("y", 0);
    }
    function hideButtons() {
      this.buttonsobj.transition(1750).delay(8250).attr("y", 16);
    }
    ...
    this.toolbar = this.fig.canvas.append("svg:svg").attr("width", 50 * this.buttons.length).attr("height", 50).attr("x", 3e3).attr("y", this.fig.height - 16 - 200).attr("class", "mpld3-toolbar");
    this.buttonsobj = this.toolbar.append("svg:g").selectAll("buttons").data(this.buttons).enter().append("svg:image").attr("class", function(d) {
      ...
      return d.icon();
    }).attr("width", 160).attr("height", 160).attr("x", function(d, i) {
      return i * 160;
    }).attr("y", 160).on("click", function(d) {
      d.click();
