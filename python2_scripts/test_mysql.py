...
cursor.execute("SELECT * from organisms WHERE organism_name = 'saccharomyces_cerevisiae';")
...
# First column of first entry in list
print x[0][0]
"""
...
user_id = 1
for username in username_shelve:
    cursor.execute("INSERT INTO users VALUES({},'{}','{}','{}')".format(user_id, username, username_shelve[username], ""))
    user_id += 1
