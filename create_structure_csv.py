...
transhelve = sqlite3.connect(
    "/home/DATA/www/tripsviz/tripsviz/trips_annotations/mus_musculus/mus_musculus.v2.sqlite"
)
cursor = transhelve.cursor()
infile = SqliteDict(
    "/home/DATA/www/tripsviz/tripsviz/uploads/structure_surfer_3/structure_surfer_vivo.sqlite"
)

cursor.execute(
    "SELECT transcript,cds_start,cds_stop,gene from transcripts WHERE principal = 1;"
)
