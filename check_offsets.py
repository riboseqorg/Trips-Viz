...
for file in os.listdir(indir):
	...
	if "aggregate" not in file:
		if "unmapped" not in file:
		        filename = (os.path.join(indir, file))
			print ("filename", filename)
			infile = SqliteDict(filename)
			offset_dict = infile["offsets"]
			if file in ["SRR970490.sqlite", "SRR970538.sqlite","SRR970561.sqlite","SRR970565.sqlite","SRR970587.sqlite","SRR970588.sqlite"]:
